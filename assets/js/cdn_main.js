...
async function getHitokoto() {
    try {
        ...
        hitokotoText.textContent = data.hitokoto || '哪有什么岁月静好，不过是有人在替你负重前行。';
        hitokotoFrom.textContent = data.from ? `- [${data.from}]` : '- [网络]';
...
// 预加载音效
const soundBlank = new Audio('https://img.nanxi.tech/file/1755346439116_click-blank.wav');
const soundBtn = new Audio('https://img.nanxi.tech/file/1755346432701_click-btn.wav');
const soundBack = new Audio('https://img.nanxi.tech/file/1755346440608_click-back.wav');
